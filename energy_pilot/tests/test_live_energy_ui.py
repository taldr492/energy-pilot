...
class LiveEnergyUiTests(unittest.TestCase):
    ...
    def test_frontend_is_served_from_separate_static_assets(self):
        ...
        self.assertIn('href="static/styles.css?v=0.3.0-native-planner-api"', self.html)
        self.assertIn('src="static/app.js?v=0.3.0-native-planner-api"', self.html)

    def test_custom_energy_icons_and_favicon_are_used(self):
        self.assertIn('href="static/house.svg?v=0.3.0"', self.html)
