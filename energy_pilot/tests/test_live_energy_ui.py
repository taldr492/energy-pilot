...
class LiveEnergyUiTests(unittest.TestCase):
    ...
    def test_frontend_is_served_from_separate_static_assets(self):
        ...
        self.assertIn('href="static/styles.css?v=0.3.2-native-overview"', self.html)
        self.assertIn('src="static/app.js?v=0.3.2-native-overview"', self.html)

    def test_custom_energy_icons_and_favicon_are_used(self):
        self.assertIn('href="static/house.svg?v=0.3.2"', self.html)
